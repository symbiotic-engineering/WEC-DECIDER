...
def retrieve_g_val_from_openMdao(model):
    g = np.zeros(14)
    g[0] = model.get_val('constraintComponent.g_0')[0]
    g[1] = model.get_val('constraintComponent.g_1')[0]
    g[2] = model.get_val('constraintComponent.g_2')[0]
    g[3] = model.get_val('constraintComponent.g_3')[0]
    g[4] = model.get_val('constraintComponent.g_4')[0]
    g[5] = model.get_val('constraintComponent.g_5')[0]
    g[6] = model.get_val('constraintComponent.g_6')[0]
    g[7] = model.get_val('constraintComponent.g_7')[0]
    g[8] = model.get_val('constraintComponent.g_8')[0]
    g[9] = model.get_val('constraintComponent.g_9')[0]
    g[10] = model.get_val('constraintComponent.g_10')[0]
    g[11] = model.get_val('constraintComponent.g_11')[0]
    g[12] = model.get_val('constraintComponent.g_12')[0]
    g[13] = model.get_val('constraintComponent.g_13')[0]
    ...
    P_elec = model.get_val('heaveDynamicsComponent.P_elec')[0]
    P_matrix = model.get_val('heaveDynamicsComponent.P_matrix')
    F_heave_max = model.get_val('heaveDynamicsComponent.F_heave_max')
