...
def waveEnergy_run_driver(b,p = None,D_f=None, D_s_over_D_f=None, h_f_over_D_f=None, T_s_over_h_s=None, F_max=None, B_p=None,w_n=None, M=0,dynamic_version = 'old',max_iter = 1000, tol = 1e-8):
    ...
    print("waveEnergy dynam version", dynamic_version)
    ...
    #outcome
    top.model.add_objective('constraintComponent.LCOE', scaler=1)
    # add constraints.
    top.model.add_constraint('constraintComponent.g_0', lower=0)
    top.model.add_constraint('constraintComponent.g_1', lower=0)
    top.model.add_constraint('constraintComponent.g_2', lower=0)
    top.model.add_constraint('constraintComponent.g_3', lower=0)
    top.model.add_constraint('constraintComponent.g_4', lower=0)
    top.model.add_constraint('constraintComponent.g_5', lower=0)
    top.model.add_constraint('constraintComponent.g_6', lower=0)
    top.model.add_constraint('constraintComponent.g_7', lower=0)
    top.model.add_constraint('constraintComponent.g_8', lower=0)
    top.model.add_constraint('constraintComponent.g_9', lower=0)
    top.model.add_constraint('constraintComponent.g_10', lower=0)
    top.model.add_constraint('constraintComponent.g_11', lower=0)
    top.model.add_constraint('constraintComponent.g_12', lower=0)
    top.model.add_constraint('constraintComponent.g_13', lower=0)
